...
var rl_movement_vector: Vector2 = Vector2.ZERO
var rl_dash_pressed: bool = false
var is_rl: bool = false

func set_rl_action(move_vec: Vector2, dash: bool) -> void:
	is_rl = true
	rl_movement_vector = move_vec
	rl_dash_pressed = dash
